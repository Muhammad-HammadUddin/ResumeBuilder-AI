  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type="text" disabled={!newSkill.trim} placeholder='Enter a skill (e.g., JavaScript,Project Management' className='flex-1 px-3 py-2 text-sm' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
            <button onClick={addSkill} className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transitin-colors disabled:opacity-50 disabled:cursor-not-allowed'>
