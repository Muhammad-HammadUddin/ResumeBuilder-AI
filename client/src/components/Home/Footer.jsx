...
const Footer = () => {
  return (
    <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-20 xl:px-25 text-[13px] text-gray-500 bg-gradient-to-r from-white  via-green-200/60 to-white mt-40 ">
